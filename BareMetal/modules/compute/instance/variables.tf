...
variable "vnic_assign_private_dns_record" {
  description = "Whether the VNIC should be assigned a DNS record. If set to false, no DNS record registion for the VNIC; if set to true, DNS record will be registered."
  type        = bool
  default     = false
}
...
variable "vnic_assign_public_ip" {
  type    = bool
  default = false
}
...
variable "vnic_skip_source_dest_check" {
  type    = bool
  default = true
}
...
variable "vnic_network_compartment_id" {
  type    = string
  default = null
}

variable "vnic_compartment_id" {
  type    = string
  default = null
}

variable "vnic_vcn_ids" {
  type    = list(any)
  default = []
}
...
variable "private_ip_display_name" {
  type    = string
  default = "private_ip"
}

variable "private_ip_hostname_label" {
  type    = string
  default = null
}

variable "private_ip_ip_address" {
  type    = string
  default = null
}

variable "private_ip_vnic_id" {
  type    = string
  default = null
}
...
variable "secrets_compartment_id" {
  type    = string
  default = null
}
